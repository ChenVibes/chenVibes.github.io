import{_ as a}from"./plugin-vue_export-helper-c27b6911.js";import{r as e,o as p,c as t,b as n,d as c,a as i,e as l}from"./app-52f3f02e.js";const o={},u={class:"hint-container warning"},d=n("p",{class:"hint-container-title"},"注意",-1),r=n("p",null,"以下不代表 scss 的所有功能，仅总结本人目前在项目大量使用过的功能",-1),v={href:"https://www.sass.hk/",target:"_blank",rel:"noopener noreferrer"},k=l(`<p>scss 里加{}，加“;”</p><p>sass 里不加{}，不加“;”</p><p><strong>根据个人习惯，使用 scss</strong></p><h2 id="变量" tabindex="-1"><a class="header-anchor" href="#变量" aria-hidden="true">#</a> 变量</h2><p>方便批量管理统一的样式</p><div class="language-scss line-numbers-mode" data-ext="scss"><pre class="language-scss"><code><span class="token property"><span class="token variable">$text-color</span></span><span class="token punctuation">:</span> #555<span class="token punctuation">;</span>
...
<span class="token selector">#main.one</span> <span class="token punctuation">{</span>
  <span class="token property">color</span><span class="token punctuation">:</span> red<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,23);function m(b,h){const s=e("ExternalLinkIcon");return p(),t("div",null,[n("div",u,[d,r,n("p",null,[n("a",v,[c("Sass 中文网"),i(s)])])]),k])}const _=a(o,[["render",m],["__file","Sass.html.vue"]]);export{_ as default};
