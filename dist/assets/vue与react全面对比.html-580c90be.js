...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,35),i=n("ul",null,[n("li",null,[n("h5",{id:"兄弟之间-1",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#兄弟之间-1","aria-hidden":"true"},"#"),s(" 兄弟之间")]),s(" 在 Vue 中，可以通过查找父组件下的子组件实例，然后进行组件进行通信。如 this."),n("span",{class:"katex"},[n("span",{class:"katex-mathml"},[n("math",{xmlns:"http://www.w3.org/1998/Math/MathML"},[n("semantics",null,[n("mrow",null,[n("mi",null,"p"),n("mi",null,"a"),n("mi",null,"r"),n("mi",null,"e"),n("mi",null,"n"),n("mi",null,"t"),n("mi",{mathvariant:"normal"},".")]),n("annotation",{encoding:"application/x-tex"},"parent.")])])]),n("span",{class:"katex-html","aria-hidden":"true"},[n("span",{class:"base"},[n("span",{class:"strut",style:{height:"0.8095em","vertical-align":"-0.1944em"}}),n("span",{class:"mord mathnormal"},"p"),n("span",{class:"mord mathnormal"},"a"),n("span",{class:"mord mathnormal"},"re"),n("span",{class:"mord mathnormal"},"n"),n("span",{class:"mord mathnormal"},"t"),n("span",{class:"mord"},".")])])]),s("children，在$children 中，可以通过组件的 name 找到要通信的组件，进而进行通信。")]),n("li",null,[n("h5",{id:"多层级组件-1",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#多层级组件-1","aria-hidden":"true"},"#"),s(" 多层级组件")]),s(" 在多层级的组件中，当然可以通过不断的获取$parent 找到需要传递的祖先级组件，然后进行通信，但是这样繁琐易错，并不推荐。Vue 在 2.2.0 新增提供了 provide/inject 的方式进行传递数据。即在祖先组件提供数据，在需要使用的组件中，注入数据，这样就可以在子组件中使用数据了。")])],-1),o=a(`<p>父组件</p><div class="language-jsx line-numbers-mode" data-ext="jsx"><pre class="language-jsx"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">&gt;</span></span><span class="token plain-text">
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="跳转参数传递和接收参数" tabindex="-1"><a class="header-anchor" href="#跳转参数传递和接收参数" aria-hidden="true">#</a> 跳转参数传递和接收参数</h4>`,14),u=[l,i,o];function d(r,k){return e(),p("div",null,u)}const b=t(c,[["render",d],["__file","vue与react全面对比.html.vue"]]);export{b as default};
