...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>$(表单）.serialize（）方法 序列化文档</p><p>jQuery 中的 ajax 方法 $.ajax</p><table><thead><tr><th>参数名称</th><th>描述</th><th>取值示例</th></tr></thead><tbody><tr><td>url</td><td>接口地址</td><td>url:&quot;02.php&quot;</td></tr><tr><td>type</td><td>请求方式</td><td>get/post type:&quot;get&quot;</td></tr><tr><td>timeout</td><td>超时时间 单位毫秒</td><td>timeout:5000</td></tr><tr><td>dataType</td><td>服务器返回的格式 json/xml/text(默认)</td><td>dataType:&quot;json&quot;</td></tr><tr><td>data</td><td>发送的请求数据 对象</td><td>data:{name:&quot;zs&quot;, age:18}</td></tr><tr><td>beforeSend</td><td>调用前的回调函数</td><td>function(){} beforeSend:function(){ alert(1) }</td></tr><tr><td>success</td><td>成功的回调函数</td><td>function (data) {} success:function (data) {}</td></tr><tr><td>error</td><td>失败的回调函数</td><td>function (error) {} error:function(data) {}</td></tr><tr><td>complete</td><td>完成后的回调函数</td><td>function () {} complete:function () {}</td></tr></tbody></table><p>其他 api</p><div class="language-JS line-numbers-mode" data-ext="JS"><pre class="language-JS"><code>// 发送get请求
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,82),l=[i];function d(c,o){return s(),a("div",null,l)}const p=n(t,[["render",d],["__file","Ajax.html.vue"]]);export{p as default};
