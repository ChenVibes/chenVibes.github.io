...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这个架构适合于大型项目，而非小项目。<br><strong>下面我们介绍一种更适合小项目的做法。</strong></p><ul><li>首先，你不需要 vendors 文件夹。可以将所有外部 CSS 代码放在头部的 link 标签内。</li><li>接下来，如果你的应用只有一个主题的话，可以省略 themes 文件夹。</li><li>最后，你可能不会有大量页面特定的风格，所以也 pages 也没必要。好了，现在只剩下 4 个文件夹了。</li><li>然后，你有两个选择：<br> 你可以按照 7-1 模式组织 CSS 代码，那么你需要留下 abstracts、components、layout 和 base 文件夹。</li></ul><p>你想将所有的分块文件和 main.css 放在一个大文件夹内，那么你会得到如下结构：</p><div class="language-SCSS line-numbers-mode" data-ext="SCSS"><pre class="language-SCSS"><code>sass/
  _animations.scss
  _base.scss
  _buttons.scss
  _header.scss
