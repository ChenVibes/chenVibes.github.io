...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="升级-node-版本" tabindex="-1"><a class="header-anchor" href="#升级-node-版本" aria-hidden="true">#</a> 升级 node 版本</h4><ul><li>1)首先:查看当前 node 版本:node –v</li><li>2)安装 n 模块:npm install -g n</li><li>3)升级到指定版本/最新版本(该步骤可能需要花费一些时间)升级之前,可以执行 n ls (查看可升级的版本)<br> 如:n 6.9.1<br> 或者你也可以告诉管理器,安装最新的稳定版本<br> n stable</li><li>4)安装完成后,查看 Node 的版本,检查升级是否成功<br> node -v</li><li>注:如果得到的版本信息不正确,你可能需要重启机器</li></ul><h4 id="cnpm" tabindex="-1"><a class="header-anchor" href="#cnpm" aria-hidden="true">#</a> cnpm</h4><h5 id="_1-npm-安装-cnpm" tabindex="-1"><a class="header-anchor" href="#_1-npm-安装-cnpm" aria-hidden="true">#</a> 1. npm 安装 cnpm</h5><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>   npm i cnpm <span class="token operator">-</span>g
...
</code></pre></li></ul></li><li>3.加载模块</li><li>4.使用模块</li><li></li></ul><h3 id="_15、如何编写模块" tabindex="-1"><a class="header-anchor" href="#_15、如何编写模块" aria-hidden="true">#</a> 15、如何编写模块:</h3>`,144),u=n("ul",null,[n("li",null,[n("p",null,"1.当前模块要写什么内容? :内容")]),n("li",null,[n("p",null,"2.这些代码是否用到外部的数据?：参数")]),n("li",null,[n("p",null,"3.是否依赖模块 ( 第三方模块、内置模块、文件模块)和一起自定义方法 ——>简: 模块(函数)"),n("p",null,"配置模块: config.js :"),n("ul",null,[n("li",null,"port"),n("li",null,"filename")]),n("p",null,"拓展模块: context.js"),n("ul",null,[n("li",null,"req.method"),n("li",null,"res.ml_render")]),n("p",null,"路由模块: router.js"),n("ul",null,[n("li",null,"记得 urlObj"),n("li",null,[s("一定要注意 内置模块, 别忘记加载 "),n("ul",null,[n("li",null,"把业务数据模块都引进来,后面提出去")])])]),n("p",null,"业务模块: handler.js"),n("ul",null,[n("li",{"css-module":"."},"module.exports.index = function(req,res)")]),n("p",null,"数据操作模块:"),n("p",null,"服务模块: app.js")])],-1),d=a(`<h3 id="_16、express-模块" tabindex="-1"><a class="header-anchor" href="#_16、express-模块" aria-hidden="true">#</a> 16、Express 模块</h3><h4 id="_1-基本步骤" tabindex="-1"><a class="header-anchor" href="#_1-基本步骤" aria-hidden="true">#</a> 1. 基本步骤</h4><pre><code>- 安装:   npm i express -S    // 安装之前: 先npm init -y 初始化 package.json 文件
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_17-模板引擎-ejs" tabindex="-1"><a class="header-anchor" href="#_17-模板引擎-ejs" aria-hidden="true">#</a> 17.模板引擎 - ejs :</h3>`,56),v={href:"https://www.npmjs.com/package/ejs",target:"_blank",rel:"noopener noreferrer"},k=n("li",null,"说明: express 里可以渲染文件 res.sendFile(),,但是不能传值,所以放弃使用;",-1),m=a(`<h4 id="ejs-基本使用" tabindex="-1"><a class="header-anchor" href="#ejs-基本使用" aria-hidden="true">#</a> ejs 基本使用</h4><ul><li><ol><li>安装: npm i ejs -S</li></ol></li><li><ol start="2"><li>加载: var ejs = require(&#39;ejs&#39;)</li></ol></li><li><ol start="3"><li>使用: 官网提供:</li></ol></li></ul><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>    <span class="token comment">// Example</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,18);function h(b,g){const e=i("ExternalLinkIcon");return p(),l("div",null,[r,u,d,n("ul",null,[n("li",null,[s("esj "),n("a",v,[s("官网"),c(e)])]),k]),m])}const y=t(o,[["render",h],["__file","Node.html.vue"]]);export{y as default};
