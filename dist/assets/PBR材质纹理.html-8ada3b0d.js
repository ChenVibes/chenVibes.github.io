import { _ as e } from './plugin-vue_export-helper-c27b6911.js'
import {
  r as t,
  o as p,
  c as o,
  ...
  a as c,
  e as l
} from './app-400f4887.js'
const i = {},
  u = n(
    'h2',
    { id: 'pbr-物理渲染', tabindex: '-1' },
    [
      n(
        'a',
        {
  ...
  r = n(
    'h3',
    { id: '什么是-pbr', tabindex: '-1' },
    [
      n(
        'a',
        { class: 'header-anchor', href: '#什么是-pbr', 'aria-hidden': 'true' },
        '#'
      ),
      s(' 什么是 PBR？')
    ],
  ...
  k = { class: 'hint-container tip' },
  d = n('p', { class: 'hint-container-title' }, '参考', -1),
  m = {
    href: 'https://zhuanlan.zhihu.com/p/342484575',
    target: '_blank',
    rel: 'noopener noreferrer'
  },
  v = l(
    `<p>基于物理渲染</p><p>以前的渲染在模仿灯光的外观</p><p>现在是在模仿光的实际行为</p><p>使图形看起来跟真实</p><h3 id="标准网格材质与光照物理效果" tabindex="-1"><a class="header-anchor" href="#标准网格材质与光照物理效果" aria-hidden="true">#</a> 标准网格材质与光照物理效果</h3><p>环境光<code>AmbientLight</code>环境光会均匀的照亮场景中的所有物体。环境光不能用来投射阴影，因为它没有方向</p><p>平行光<code>DirectionalLight</code> ,必须设置<code>positon</code>它的方向是从一个平行光的位置<code> position</code>到 <code>target</code>(默认(0,0,0))的位置</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token operator">*</span> <span class="token keyword">as</span> <span class="token constant">THREE</span> <span class="token keyword">from</span> <span class="token string">&#39;three&#39;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="置换贴图与顶点细分设置" tabindex="-1"><a class="header-anchor" href="#置换贴图与顶点细分设置" aria-hidden="true">#</a> 置换贴图与顶点细分设置</h2>`,
    9
  )
function b(h, w) {
  const a = t('ExternalLinkIcon')
  return (
    p(),
    o('div', null, [
      u,
      r,
      n('div', k, [d, n('p', null, [n('a', m, [s('什么是 PBR？'), c(a)])])]),
      v
    ])
  )
}
