...
const i = {},
  r = s(
    `<h2 id="使用纹理" tabindex="-1"><a class="header-anchor" href="#使用纹理" aria-hidden="true">#</a> 使用纹理</h2><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token operator">*</span> <span class="token keyword">as</span> <span class="token constant">THREE</span> <span class="token keyword">from</span> <span class="token string">&#39;three&#39;</span>
...
function k(m, v) {
  ...
  return (
    ...
    o('div', null, [
      ...
      n('p', null, [
        n('a', u, [
          c('Mipmap 详解(有无 Mipmap 区别、原理、优点、缺点、优化)'),
          l(a)
        ])
      ]),
      d
