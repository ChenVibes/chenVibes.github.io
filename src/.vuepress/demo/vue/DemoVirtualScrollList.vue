<template>
	<div class="scroll-list" :style="virtualScrollStyle">
		<virtual-scroll-list data-key="value" :data-sources="region" :data-component="DemoVirtualScrollListItem" :style="virtualScrollStyle" :estimate-size="32" v-bind="virtualProps" />
	</div>
</template>

<script setup>
import { ref, onMounted, defineComponent } from 'vue'
import DemoVirtualScrollListItem from './DemoVirtualScrollListItem.vue'
