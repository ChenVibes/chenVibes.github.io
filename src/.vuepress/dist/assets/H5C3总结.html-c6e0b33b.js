import{_ as r}from"./plugin-vue_export-helper-c27b6911.js";import{r as s,o as t,c as l,a as e,b as n,d,e as a}from"./app-cef5cfc8.js";const o={},c=a(`<h4 id="_1-怎么让一个不定宽高的-div-垂直水平居中" tabindex="-1"><a class="header-anchor" href="#_1-怎么让一个不定宽高的-div-垂直水平居中" aria-hidden="true">#</a> 1，怎么让一个不定宽高的 Div，垂直水平居中</h4><p>1）使用 css 方法:</p><pre><code>父盒子设置：
display：table-cell;
text-align:center;
...
</code></pre><h4 id="_11-h5-css3-新增属性有哪些" tabindex="-1"><a class="header-anchor" href="#_11-h5-css3-新增属性有哪些" aria-hidden="true">#</a> 11.H5 css3 新增属性有哪些？</h4><h5 id="h5" tabindex="-1"><a class="header-anchor" href="#h5" aria-hidden="true">#</a> h5</h5><ul><li>1.语义化标签 <ul><li>header、footer、aside、section、article、nav</li></ul></li><li>2.表单输入类型</li></ul><p>email、url、number、range、Date Pickers、search、color</p><ul><li>3.表单属性</li></ul><p>autocomplete、placeholder、form</p><ul><li>4.视频音频</li></ul><p>video、audio</p><ul><li>5.画布</li></ul><p>canvas</p><ul><li>6.伸缩矢量图</li></ul><p>svg</p><ul><li>7.拖拽属性</li></ul><p>draggable</p><ul><li>8.事件</li></ul><p>resize<br> input</p><ul><li>9.地理定位</li></ul><p>Geolocation</p>`,59),p={href:"http://10.web",target:"_blank",rel:"noopener noreferrer"},h=a(`<p>sessionStorage 和 localStorage</p><ul><li>11.应用程序缓存 application cache</li></ul><p>创建 chche manifest 文件</p><ul><li>12.文件通讯协议</li></ul><p>websocket</p><ul><li>13.文件读取</li></ul><p>fileReader</p><ul><li>14.类名操作</li></ul><p>classlist</p><h5 id="css3" tabindex="-1"><a class="header-anchor" href="#css3" aria-hidden="true">#</a> CSS3</h5><ul><li><p>1.颜色：新增 RGBA,HSLA 模式</p></li><li><p>2.文字阴影： text-shadow</p></li><li><p>3.边框：圆角（border-radius）边框阴影：box-shadow</p></li><li><p>4.盒子模型：box-sizing</p></li><li><p>5.背景：<br> background-size 设置毕竟图片的尺寸</p><p>background-origin 设置背景图片的原点<br> background-clip 设置背景图片的裁切区域，一“，”分隔可以设置多背景，用于自适应布局</p></li><li><p>6.渐变：<br> linear-gradient 线性渐变<br> radial-gradient 径向渐变</p></li><li><p>7.过渡：transition，可实现动画</p></li><li><p>8.自定义动画：<br> animation：<br> 动画名称<br> 执行时间<br> 执行次数<br> 动画方向<br> 延迟时间<br> 执行的最终状态<br> 动画运动方式<br> 暂停或终止</p></li><li><p>9.在 CSS3 中唯一引入的伪元素：：selection 可改变选中文本的样式<br> p::selection{<br> color:orange;<br> }</p></li><li><p>10.媒体查询，多栏布局<br> @media (max-width:640){<br> html{<br> font-size:40px;<br> }<br> }</p></li><li><p>11.border-image</p></li><li><p>12.2d 转换：transform：translate（x，y） rotate（x，y）<br> skew（x，y） scale（x，y）</p></li><li><p>13.3d 转换：</p><p>当元素定义 perspective 属性是，其子元素会获得透视效果。<br> （给父元素加）；perspective 属性值越小，离屏幕越近</p><p>translate3d（x，y，z）x 和 y 可以是长度值，也可以是百分<br> 比，相对于其本身元素水平方向的宽和垂直方向的高度和；<br> z 只能设置长度值</p></li><li><p>14.弹性盒子<br> flex</p></li><li><ol start="15"><li>媒体查询</li></ol></li></ul><p>@media</p><h4 id="_12、xhtml-和-html-有什么区别" tabindex="-1"><a class="header-anchor" href="#_12、xhtml-和-html-有什么区别" aria-hidden="true">#</a> 12、xhtml 和 html 有什么区别？</h4><pre><code>html是基本的web网页设计语言，xhtml是一个基于xml的置标语言。最主要的不同：
xhtml元素必须被正确地嵌套
...
</code></pre><h4 id="_36、overflow-有哪些属性值" tabindex="-1"><a class="header-anchor" href="#_36、overflow-有哪些属性值" aria-hidden="true">#</a> 36、overflow 有哪些属性值?</h4><p>visibility:默认值，内容不会被修剪，呈现在盒子之外</p><p>hidden:内容被修剪，并且多余的内容不可见</p><p>scroll:内容会被修剪，但是浏览器会显示滚动条以便查看其余的内容</p><p>auto:如果内容被修剪，则浏览器会显示滚动条以便查看其余的内<br> 容</p><p>inherit:规定应该从父元素继承 overflow 属性的值</p><h4 id="_37、rgba-和-opacity-的透明效果有什么不同" tabindex="-1"><a class="header-anchor" href="#_37、rgba-和-opacity-的透明效果有什么不同" aria-hidden="true">#</a> 37、rgba()和 opacity 的透明效果有什么不同?</h4><pre><code>rgba()和 opacity 都能实现透明效果.
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,81);function b(u,m){const i=s("ExternalLinkIcon");return t(),l("div",null,[c,e("ul",null,[e("li",null,[e("a",p,[n("10.web"),d(i)]),n(" 存储")])]),h])}const x=r(o,[["render",b],["__file","H5C3总结.html.vue"]]);export{x as default};
