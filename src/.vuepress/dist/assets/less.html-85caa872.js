import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{r as p,o as e,c,a as n,b as l,d as o,e as s}from"./app-cef5cfc8.js";const u={},i=s(`<h4 id="_1-定义变量" tabindex="-1"><a class="header-anchor" href="#_1-定义变量" aria-hidden="true">#</a> 1.定义变量</h4><div class="language-css line-numbers-mode" data-ext="css"><pre class="language-css"><code>    @color：red；
    @container：1280px
    //定义变量  不会被解析到css文件的注释
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_6-rem" tabindex="-1"><a class="header-anchor" href="#_6-rem" aria-hidden="true">#</a> 6.rem</h4><p><strong>em 是一个相对单位，相对的是当前这个盒子本身的 font-size 大小</strong></p><p><strong>rem 是一个相对单位，相对的是 html 的字体大小</strong></p><p>Rem 的宽高自适应原理：<br> 所有的 rem 单位都是基于 html 的字体大小，在不同的屏<br> 幕下面，修改 html 的字体大小就可以实现自适应效果。</p><p>Rem 计算公式：设计图的大小/自己自定义的 html 的 font-size=改变后的屏幕大小/这个屏幕对应的 font-size 值；</p>`,16),r={href:"https://github.com/Maroon1/px2rem",target:"_blank",rel:"noopener noreferrer"},k=s(`<h4 id="_7、函数" tabindex="-1"><a class="header-anchor" href="#_7、函数" aria-hidden="true">#</a> 7、函数</h4><div class="language-css line-numbers-mode" data-ext="css"><pre class="language-css"><code>    <span class="token function">escape</span><span class="token punctuation">(</span><span class="token atrule"><span class="token rule">@string</span><span class="token punctuation">)</span><span class="token punctuation">;</span></span> // 通过 URL-encoding 编码字符串
...
3. 如果浏览器禁用了js，那么无法生效
4. 线上编译，可能出现短暂的css混乱
</code></pre>`,5);function d(v,m){const a=p("ExternalLinkIcon");return e(),c("div",null,[i,n("p",null,[n("a",r,[l("https://github.com/Maroon1/px2rem"),o(a)])]),k])}const f=t(u,[["render",d],["__file","less.html.vue"]]);export{f as default};
