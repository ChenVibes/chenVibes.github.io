import{_ as a}from"./plugin-vue_export-helper-c27b6911.js";import{r as i,o as h,c as n,a as e,b as t,d as r,e as s}from"./app-cef5cfc8.js";const c={},l=e("h4",{id:"第一次使用配置操作",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#第一次使用配置操作","aria-hidden":"true"},"#"),t(" 第一次使用配置操作")],-1),o={href:"http://user.name",target:"_blank",rel:"noopener noreferrer"},g=e("br",null,null,-1),u=e("br",null,null,-1),p={href:"http://user.name",target:"_blank",rel:"noopener noreferrer"},m=e("br",null,null,-1),b=e("a",{href:"mailto:111111@qq.com"},"111111@qq.com",-1),_=s(`<pre><code># 查看配置信息
...
</code></pre><h4 id="在-bash-中依次输入以下命令" tabindex="-1"><a class="header-anchor" href="#在-bash-中依次输入以下命令" aria-hidden="true">#</a> 在 bash 中依次输入以下命令：</h4><ol><li><p>创建 SSH key：ssh-keygen -t rsa</p></li><li><p>在文件路径 C:\\用户\\当前用户名\\ 找到 .ssh 文件夹</p></li><li><p>文件夹中有两个文件：</p><ul><li>私钥：id_rsa</li><li>公钥：id_rsa.pub</li></ul></li><li><p>在 github -&gt; settings -&gt; SSH and GPG keys 页面中，新创建 SSH key，粘贴公钥 id_rsa.pub 内容到对应文本框中</p></li><li><p>在 github 中新建仓库或者使用现在仓库，拿到git@github.com:用户名/仓库名.git</p></li><li><p>此后，再次 SSH 方式与 github“通信”，不用输入密码确认身份了</p></li></ol>`,54);function x(f,k){const d=i("ExternalLinkIcon");return h(),n("div",null,[l,e("p",null,[t("git config "),e("a",o,[t("user.name"),r(d)]),t(" 你的目标用户名"),g,t(" git config user.email 你的目标邮箱名")]),e("p",null,[t("使用--global 参数，配置全局的用户名和邮箱，只需要配置一次即可。"),u,t(" git config --global "),e("a",p,[t("user.name"),r(d)]),t(" hucc"),m,t(" git config --global user.email "),b]),_])}const j=a(c,[["render",x],["__file","Git版本控制工具.html.vue"]]);export{j as default};
