import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{r as p,o as t,c,b as n,d as o,a as i,e as s}from"./app-98dc3ef1.js";const l={},u=s(`<p>// TODO: 2022.5.23 基于 ES6 入门 class 章节重新梳理</p><h2 id="class-基本用法" tabindex="-1"><a class="header-anchor" href="#class-基本用法" aria-hidden="true">#</a> Class 基本用法</h2><p>类名一般首字母大写</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">class</span> <span class="token class-name">Person</span> <span class="token punctuation">{</span>
