import{_ as r,r as a,o as i,c as d,b as e,d as n,a as o,e as h}from"./app-c17MCxSj.js";const c={},s=h(`<h3 id="一-发送效果" tabindex="-1"><a class="header-anchor" href="#一-发送效果" aria-hidden="true">#</a> 一.发送效果</h3><h4 id="html" tabindex="-1"><a class="header-anchor" href="#html" aria-hidden="true">#</a> HTML</h4><pre><code>&lt;div id=&quot;send-btn&quot;&gt;
  &lt;button&gt;
// 这里是一个svg的占位
Send
  &lt;/button&gt;
...
复制代码
</code></pre><h4 id="gif-图-3" tabindex="-1"><a class="header-anchor" href="#gif-图-3" aria-hidden="true">#</a> GIF 图</h4><figure><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/514387debb8643a19bf3311bb1b735c1~tplv-k3u1fbpfcp-zoom-1.image" alt="hover_effect_radius" tabindex="0" loading="lazy"><figcaption>hover_effect_radius</figcaption></figure><h3 id="六-冰冻效果" tabindex="-1"><a class="header-anchor" href="#六-冰冻效果" aria-hidden="true">#</a> 六.冰冻效果</h3><h4 id="html-5" tabindex="-1"><a class="header-anchor" href="#html-5" aria-hidden="true">#</a> HTML</h4><pre><code>&lt;div id=&quot;frozen-btn&quot;&gt;
...
复制代码
</code></pre><h4 id="gif-图-6" tabindex="-1"><a class="header-anchor" href="#gif-图-6" aria-hidden="true">#</a> GIF 图</h4><figure><img src="https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/eee9698995b9441ba3fa622780e5cba8~tplv-k3u1fbpfcp-zoom-1.image" alt="hover_effect_load" tabindex="0" loading="lazy"><figcaption>hover_effect_load</figcaption></figure><h3 id="总结" tabindex="-1"><a class="header-anchor" href="#总结" aria-hidden="true">#</a> 总结</h3>`,57),b=e("code",null,":before",-1),l=e("code",null,":after",-1),p={href:"https://www.blog.duomly.com/html-button-hover-effects/",target:"_blank",rel:"noopener noreferrer"},f={href:"https://github.com/reng99/blogs",target:"_blank",rel:"noopener noreferrer"};function g(u,x){const t=a("ExternalLinkIcon");return i(),d("div",null,[s,e("p",null,[n("巧用伪元素"),b,n("、"),l,n("等，让你的页面按钮眼前一亮。原文链接："),e("a",p,[n("8 amazing HTML button hover effects, that will make your website memorable"),o(t)]),n("。更多内容："),e("a",f,[n("github.com/reng99/blog…"),o(t)])])])}const v=r(c,[["render",g],["__file","CSS八种让人眼前一亮的HOVER效果.html.vue"]]);export{v as default};
