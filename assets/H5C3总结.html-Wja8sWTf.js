import{_ as e,o as n,c as a,e as i}from"./app-c17MCxSj.js";const s={},t=i(`<h4 id="_1-怎么让一个不定宽高的-div-垂直水平居中" tabindex="-1"><a class="header-anchor" href="#_1-怎么让一个不定宽高的-div-垂直水平居中" aria-hidden="true">#</a> 1，怎么让一个不定宽高的 Div，垂直水平居中</h4><p>1）使用 css 方法:</p><pre><code>父盒子设置：
display：table-cell;
text-align:center;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,141),r=[t];function d(l,c){return n(),a("div",null,r)}const p=e(s,[["render",d],["__file","H5C3总结.html.vue"]]);export{p as default};
