...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="报错" tabindex="-1"><a class="header-anchor" href="#报错" aria-hidden="true">#</a> 报错</h2><p>::: warning</p><p>使用国内脚本安装，可能会遇到此问题。使用官方脚本无此问题</p><p>:::</p><p>fatal: not in a git directory Error: Command failed with exit 128: git</p><p><strong>解决办法</strong>：执行 brew -v 命令看看是不是有两个提示，你的 homebrew-core 和 homebrew-cask 目录被 git 认为不是一个安全的目录，需要手动添加 git config --global --add safe.directory 你的 homebrew-core 路径 git config --global --add safe.directory 你的 homebrew-cask 路径</p><h2 id="注意" tabindex="-1"><a class="header-anchor" href="#注意" aria-hidden="true">#</a> 注意</h2><p>::: tip 提示</p><p>使用 brew uninstall git 卸载软件只会卸载软件本身而不会同时卸载其依赖包，使用以下命令可完全卸载，并且不会影响到其他软件。需要科学上网！</p><p><code>brew tap beeftornado/rmtree</code></p><p>结束后执行如下命令即可完全卸载软件。</p><p><code>brew rmtree git</code></p><p>:::</p><h2 id="mysql" tabindex="-1"><a class="header-anchor" href="#mysql" aria-hidden="true">#</a> mysql</h2>`,25),p={href:"https://blog.csdn.net/x123089/article/details/79729563",target:"_blank",rel:"noopener noreferrer"},u=i(`<p>通过 homebrew 安装：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>brew <span class="token function">install</span> mysql
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="nvm" tabindex="-1"><a class="header-anchor" href="#nvm" aria-hidden="true">#</a> nvm</h2>`,13),v={href:"/node%E6%8A%80%E6%9C%AF%E6%A0%88/node%E5%9F%BA%E7%A1%80%E7%9F%A5%E8%AF%86&%E5%B7%A5%E5%85%B7#nvm",target:"_blank",rel:"noopener noreferrer"},m=i(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>brew <span class="token function">install</span> nvm
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="mongodb" tabindex="-1"><a class="header-anchor" href="#mongodb" aria-hidden="true">#</a> mongodb</h2><ol><li>brew tap mongodb/brew</li><li>brew install mongodb-community</li><li>启动：brew services start mongodb-community</li><li>停止 ：brew services stop mongodb-community</li></ol>`,3),b={href:"https://www.jianshu.com/p/8db0b29a931d",target:"_blank",rel:"noopener noreferrer"},h={href:"https://github.com/mongodb/homebrew-brew",target:"_blank",rel:"noopener noreferrer"},k=n("h2",{id:"fd",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#fd","aria-hidden":"true"},"#"),s(" fd")],-1),g=n("code",null,"everything",-1),f={href:"https://github.com/sharkdp/fd",target:"_blank",rel:"noopener noreferrer"},y=n("h2",{id:"autojump",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#autojump","aria-hidden":"true"},"#"),s(" autojump")],-1),q={href:"https://github.com/wting/autojump",target:"_blank",rel:"noopener noreferrer"},w=i(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># .zshrc</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="zsh-syntax-highlighting" tabindex="-1"><a class="header-anchor" href="#zsh-syntax-highlighting" aria-hidden="true">#</a> zsh-syntax-highlighting</h2>`,2),_={href:"https://github.com/zsh-users/zsh-syntax-highlighting",target:"_blank",rel:"noopener noreferrer"},x=i(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># .zshrc</span>
...
└── utils
    ├── connect.js
    └── context.js
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,10);function S(j,L){const e=t("ExternalLinkIcon");return o(),r("div",null,[c,n("p",null,[n("a",p,[s("安装教程"),a(e)])]),u,n("p",null,[n("a",v,[s("更多细节"),a(e)])]),m,n("p",null,[n("a",b,[s("安装教程"),a(e)])]),n("p",null,[n("a",h,[s("github"),a(e)])]),k,n("p",null,[s("检索文件工具，速度较快，比"),g,s("还是差一点,"),n("a",f,[s("github"),a(e)])]),y,n("p",null,[n("a",q,[s("autojump"),a(e)]),s(",快速跳转目录(只能跳转已经 cd 过的目录)")]),w,n("p",null,[n("a",_,[s("zsh-syntax-highlighting"),a(e)]),s(":高亮终端的代码")]),x])}const Y=l(d,[["render",S],["__file","homebrew.html.vue"]]);export{Y as default};
