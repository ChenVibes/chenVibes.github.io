import{_ as n,o as s,c as a,e as t}from"./app-9gJpSWLU.js";const p={},e=t(`<h4 id="_1-定义变量" tabindex="-1"><a class="header-anchor" href="#_1-定义变量" aria-hidden="true">#</a> 1.定义变量</h4><div class="language-css line-numbers-mode" data-ext="css"><pre class="language-css"><code>    @color：red；
    @container：1280px
    //定义变量  不会被解析到css文件的注释
...
3. 如果浏览器禁用了js，那么无法生效
4. 线上编译，可能出现短暂的css混乱
</code></pre>`,22),c=[e];function l(o,u){return s(),a("div",null,c)}const r=n(p,[["render",l],["__file","less.html.vue"]]);export{r as default};
