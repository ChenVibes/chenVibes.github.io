import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{o as d,c as e,e as i}from"./app-444c4a7e.js";const r={},a=i(`<h4 id="第一次使用配置操作" tabindex="-1"><a class="header-anchor" href="#第一次使用配置操作" aria-hidden="true">#</a> 第一次使用配置操作</h4><p>git config user.name 你的目标用户名 git config user.email 你的目标邮箱名</p><p>使用--global 参数，配置全局的用户名和邮箱，只需要配置一次即可。 git config --global user.name hucc git config --global user.email 111111@qq.com</p><pre><code># 查看配置信息
