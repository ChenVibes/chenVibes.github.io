...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="跳转参数传递和接收参数" tabindex="-1"><a class="header-anchor" href="#跳转参数传递和接收参数" aria-hidden="true">#</a> 跳转参数传递和接收参数</h4>`,50),c=[p];function l(i,o){return s(),a("div",null,c)}const d=n(e,[["render",l],["__file","vue与react全面对比.html.vue"]]);export{d as default};
